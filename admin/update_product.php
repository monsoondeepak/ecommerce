...
if(!empty($image_01)){
    if($image_01_size > 2000000){
        ...
        $message[] = 'image 01 updated succesfully!';
    }
}
    ...
    if(!empty($image_02)){
        if($image_02_size > 2000000){
            ...
            $message[] = 'image 02 updated succesfully!';
        }
    }
    ...
    if(!empty($image_03)){
        if($image_03_size > 2000000){
            ...
            $message[] = 'image 03 updated succesfully!';
        }
    }
...
<div class="image-container">
    ...
    <textarea name="details" class="box" placeholder="enter product details" maxlenght="500" cols="30" rows="10" id="" cols="30"><?= $fetch_products['details']; ?></textarea>
